  ...
  <div class="max-w-6xl mx-auto px-4 py-8">
    <div class="space-y-6">
      ...
      <div class="fixed top-24 left-6 z-30 flex items-center gap-4" style="min-width: 260px;">
        <button
          @click="goBack"
          class="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-primary-from to-primary-to text-white font-semibold shadow hover:from-primary-to hover:to-primary-from transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary-from"
        >
